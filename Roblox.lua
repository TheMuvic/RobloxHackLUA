...
function updateStatus()
	statusLabel.Text = "[F] Полёт: " .. (flying and "ВКЛ" or "ВЫКЛ") .. "\n[8] Анти-АФК: " .. (antiAFKEnabled and "ВКЛ" or "ВЫКЛ")
	if flying then
		statusLabel.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- зелёный
	elseif antiAFKEnabled then
		statusLabel.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- зелёный
	else
		statusLabel.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- красный
	end
end
updateStatus()
